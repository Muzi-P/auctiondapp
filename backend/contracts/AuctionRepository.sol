...
contract  AuctionRepository {
 ...
 struct Auction {
    ...
    function createAuction(address _deedRepositoryAddress, uint256 _deedId, string memory _auctionTitle, string memory _metadata, uint256 _startPrice, uint _blockDeadline) 
    public 
    ...
    returns(bool) {
        ...
        newAuction.blockDeadline = block.timestamp  +  60 * _blockDeadline;
